package com.example.auditlogservice.Config.filter.specification;

import com.example.auditlogservice.Config.filter.clause.Clause;
import com.example.auditlogservice.Config.filter.clause.ClauseArrayArgs;
import com.example.auditlogservice.Config.filter.clause.ClauseOneArg;
import com.example.auditlogservice.Config.filter.clause.ClauseTwoArgs;
